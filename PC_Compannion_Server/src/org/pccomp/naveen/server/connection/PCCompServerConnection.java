...
import org.pccomp.naveen.protocol.action.AuthentificationAction;
import org.pccomp.naveen.protocol.action.AuthentificationResponseAction;
import org.pccomp.naveen.protocol.action.FileExploreRequestAction;
import org.pccomp.naveen.protocol.action.FileExploreResponseAction;
import org.pccomp.naveen.protocol.action.KeyboardAction;
import org.pccomp.naveen.protocol.action.MouseClickAction;
import org.pccomp.naveen.protocol.action.MouseMoveAction;
import org.pccomp.naveen.protocol.action.MouseWheelAction;
import org.pccomp.naveen.protocol.action.PCCompAction;
import org.pccomp.naveen.protocol.action.ScreenCaptureRequestAction;
import org.pccomp.naveen.protocol.action.ScreenCaptureResponseAction;
import org.pccomp.naveen.server.PCCompServerApp;
import org.pccomp.naveen.server.tools.UnicodeToSwingKeyCodeConverter;

public class PCCompServerConnection implements Runnable
{
        ...
        public PCCompServerConnection(PCCompServerApp application, PCCompConnection connection)
        {
                ...
                this.useUnicodeWindowsAltTrick = PCCompServerApp.IS_WINDOWS && !this.application.getPreferences().getBoolean("force_disable_unicode_windows_alt_trick", false);
		...
		public void run()
        {
                try
                {
                        try
                        {
                                while (true)
                                {
                                        PCCompAction action = this.connection.receiveAction();
        ...
        private void action(PCCompAction action)
        {
        ...
        {
                if (action.password.equals(this.application.getPreferences().get("password", PCCompConnection.DEFAULT_PASSWORD)))
                {
        ...
        private void sendAction(PCCompAction action)
        {
                try
                {
