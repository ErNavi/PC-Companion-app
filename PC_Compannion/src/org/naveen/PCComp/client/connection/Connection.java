...
import org.naveen.PCComp.client.activity.connection.ConnectionEditActivity;
...
public abstract class Connection implements Comparable<Connection>, Serializable
{
        ...
        {
                this.name = "";
                this.password = PCCompConnection.DEFAULT_PASSWORD;
        }
        ...
        public abstract PCCompConnection connect(PCComp application) throws IOException;
